(function($) {
    ...
    $( document ).ready(function() {
        ...
        function add_wallet_money(serviceid){
            $.ajax({
                type:'POST',
                url: base_url+'user/service/payment_gateway',
                data: {service_id: serviceid,csrf_token_name:csrf_token},
                success: function(data){
                    try{
                        alert('Work here');
                    }catch(e) {
...
>>>>>>> 5d6821d2e88c778b1d6265f82f022bc9971934f1
