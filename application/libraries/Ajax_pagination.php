...
class Ajax_pagination{
	...
	function create_links(){
		...
		?>
		<input type="hidden" id="pagination_current_page" value="<?php echo $this->base_url; ?>">
		<input type="hidden" id="target" value="<?php echo $this->target; ?>">
