...
<div id="container">
	<h1>Welcome to CodeIgniter!</h1>
		...
		<div class="filter-list">
				<h4 class="filter-title">Generic</h4>
					<select id="generic" class="form-control form-control selectbox select">
						<option value="">All Generic</option>
								<?php foreach ($generic as $crows) {
									echo '<option value="'.$crows['id'].'">'.$crows['generic_name'].'</option>';
								}?>
					</select>
		</div>
