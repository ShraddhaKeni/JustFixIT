		...
		<div class="row">
			...
			<div class="row" id="dataList">
				...
				?>
											...
											<div class="social-icon">
												<center>
													<ul>
														...
														<li style="display: inline; padding-left: 10px; padding-right: 10px;">
															<a href="http://www.linkedin.com/shareArticle?mini=true&url==<?php echo base_url().$srows['service_title'];?>" target="_blank"><i class="fab fa-linkedin" aria-hidden="true"></i></a>
														</li>
													</ul>
												</center>
											</div>
						...
						echo '<div class="col-lg-12"><p class="mb-0">No Services Found</p></div>';
					} 
