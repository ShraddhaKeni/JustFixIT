	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-10">		
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="booking_date" id="booking_date" required/>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control from_time" name="from_time" id="from_time" required></select>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
				...
				<?php }else{ ?>
				<form method="post" action="https://www.cashfree.com/checkout/post/submit" id="book_services"> 
				<?php } ?>
		         	<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
					...
					<div class="submit-section">
						<?php if($wallet_amt[0]->wallet_amt >= $service_details['service_amount']) { ?>
							<button class="btn btn-primary" id="mybtn" type="button" data-id="1">Continue to Book</button>
						<?php }else{ ?>
							<button class="btn btn-primary submit-btn submit_service_book" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Order" data-id="<?php echo $service_details['id']; ?>" data-provider="<?php echo $service_details['user_id']?>" data-amount="<?php echo $service_details['service_amount']; ?>" id="bsub" type="submit" disabled>Continue to Book</button>
							<span id="rspan" style="color:red">Please fill the required details</span>
							<!--<button class="btn btn-primary" id="mybtn" type="button" data-id="2">Continue to Book</button>-->
						<?php } ?>
					</div>
						...
						<div class="modal-dialog" role="document">
					   		<div class="modal-content">
					   			...
					   			<div class="modal-body">
					       			<center><button class="btn btn-primary" id="walletsub">Wallet</button></center>
					       			<center>OR</center>
