		...
		<div class="row">
			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						<div class="row">
						<h5 class="card-title d-flex justify-content-between col-sm-8">
						...
						<?php
							if($user_details['is_verified']==0){
								?>
							<input  id="status_<?php echo $user_details['id'];?>" class="check verified_change" data-id="<?php echo $user_details['id'];?>" type="checkbox">
							<label  for="status_<?php echo $user_details['id'];?>" class="checktoggle">checkbox</label>
							<?php }else{
								?>
							<input id="status_<?php echo $user_details['id'];?>" class="check verified_change" data-id="<?php echo $user_details['id'];?>" type="checkbox" checked>
							<label for="status_<?php echo $user_details['id'];?>" class="checktoggle">checkbox</label>
							<?php
							}
							?>
