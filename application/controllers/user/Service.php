...
{ 
  ...
  $sql="update services set service_image='".$service_image."',service_details_image='".$service_details_image."',thumb_image='".$thumb_image."',mobile_image='".$mobile_image."', service_title='".$this->input->post('service_title')."',service_sub_title='".$this->input->post('service_sub_title')."',category='".$this->input->post('category')."',subcategory='".$this->input->post('subcategory')."',service_location='".$this->input->post('service_location')."',service_latitude='".$this->input->post('service_latitude')."',service_longitude='".$this->input->post('service_longitude')."',service_amount='".$this->input->post('service_amount')."',service_offered= '".$service_offered."',about='".$this->input->post('about')."',updated_at='".date('Y-m-d H:i:s')."' where id='".$_POST['service_id']."'";
...
public function update_bookingstatus()
{
  ...
  $book_details['updated_on'] = utc_date_conversion(date('Y-m-d H:i:s'));
...
public function booking()
{
  ...
  $user_post_data['currency_code']     = 'USD';
